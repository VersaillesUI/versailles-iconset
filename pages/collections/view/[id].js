          ...
          !!iconset && <div className={classes.propertyPanel}>
            ...
            <Box>
              ...
              <Box marginTop={-0.5}>
                ...
                <Info label="库类型">{iconset.isFontset ? '字体库' : '图片库'}</Info>
              </Box>
            </Box>
            <br />
            <Box>
            ...
            <Box position="absolute" right={24} bottom={24} display="flex" alignItems="flex-end" flexDirection="column">
              {
                !isOwner && <Tooltip title="收藏此图标库" aria-label="收藏此图标库">
              ...
              }
              {
                isOwner && <Tooltip title="配置管理" aria-label="配置管理">
                  <Fab href={`/collections/view/settings?id=${iconset.id}`}>
                    <SettingsIcon />
                  </Fab>
                </Tooltip>
              }
              ...
              {
                !!iconset.isFontset && <Tooltip title="生成字体文件，下载并预览" aria-label="生成字体文件，下载并预览">
